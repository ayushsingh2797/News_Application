...
class NewsRVAdapter(context: Context,articlesList : List<Article>?): RecyclerView.Adapter<NewsRVAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) = holder.bind(mArticlesList!![position],position)

    override fun getItemCount(): Int {
        return mArticlesList!!.size
    }

    inner class ViewHolder(private val binding:NewsRvItemBinding): RecyclerView.ViewHolder(binding.root) {
